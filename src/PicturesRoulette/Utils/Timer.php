...
class Timer
{
    ...
    public function stop(string $_section_name): float
    {
        ...
        $this->timeSections[$_section_name][self::TIME_TOTAL] = $this->timeSections[$_section_name][self::TIME_END]
            - $this->timeSections[$_section_name][self::TIME_START];
